...
Ball::Ball(float x, float y, color_t color) {
    ...
    GLfloat vertex_buffer_data3[] = {
            .05f*cos(this->rotation*M_PI/180.0f),0,3,
            .05f*cos(this->rotation*M_PI/180.0f),0, 1.5f,
            .05f*cos(this->rotation*M_PI/180.0f),0.758f,2.25f,
        };

    this->object2 = create3DObject(GL_TRIANGLES, 8*3, vertex_buffer_data2, COLOR_GREEN, GL_FILL);
    this->object3 = create3DObject(GL_TRIANGLES, 1*3, vertex_buffer_data3, {0,0,0}, GL_FILL);
}
